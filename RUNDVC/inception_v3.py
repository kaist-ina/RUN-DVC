...
# adapted from https://github.com/pytorch/vision/blob/main/torchvision/models/inception.py
...
class Inception3(nn.Module):
    def __init__(
        ...
        if platform == "ilmn":
            # self.Conv2d_1a_3x3 = conv_block(7, 32, kernel_size=3, stride=2)
            self.Conv2d_1a_3x3 = conv_block(7, 32, kernel_size=3, stride=1)
        else:
            # self.Conv2d_1a_3x3 = conv_block(8, 32, kernel_size=3, stride=2)
            self.Conv2d_1a_3x3 = conv_block(8, 32, kernel_size=3, stride=1)
