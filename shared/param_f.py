...
load_input_shape = [matrix_depth_dict['hifi'], no_of_positions, channel_size]
load_ont_input_shape = [matrix_depth_dict['ont'], no_of_positions, channel_size]
load_label_shape = [21, 3, no_of_positions, no_of_positions]
load_label_size = sum(load_label_shape)
load_label_shape_cum = list(accumulate(load_label_shape))
